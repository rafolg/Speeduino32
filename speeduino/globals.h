...
extern volatile bool wirelessSerial; //Tracks wether or not the wireless Serial interface has been enabled or not
...
extern volatile uint16_t knockCount; /**< The count of knock search events that have taken place since the engine started */
...
extern int CRANK_ANGLE_MAX_KNK;
...
struct config9 {
  ...
  byte enableWserial : 1;
  byte unused10_182 : 5;
  byte primingScaleValue;
  byte ignRptScale; // byte 184
...
struct config10 {
  ...
  byte wmiPin : 6;
  byte unused11_190_6_7 : 2;
  byte wmiFreq;
#else
  byte unused11_190_191[2];
#endif
...
struct config15 {
  ...
  byte knockEnable : 1;
  byte knockRef : 1;
  byte unused15_1 : 5; //5bits unused
  ...
  uint8_t knockWindow;
  byte knockFreqA : 6;
  byte unused15_100_6_7 : 2;
  byte knockGain : 6;
  byte unused15_101_6_7 : 2;
  byte knockFreqB : 6;
  byte unused15_102_6_7 : 2;
  byte knockFreqC : 6;
  byte wifiSecurity : 2; //Byte 103 bits 6_7
  byte knockFreqD : 6;
  byte unused15_104_6 : 1;

  //Bytes 105-255
  //byte Unused15_105_255[151];
  
  byte wifiMode : 1; //Byte 104 bit 7
  char SSID[17]; //Bytes 105-121
  char WPWD[17]; //Bytes 122-138
  byte Unused15_137_255[117]; //Bytes 139-255
...
#if(defined(CORE_TEENSY))
extern byte pinWMI;         // WMI output
extern byte pinWserial;
#endif
