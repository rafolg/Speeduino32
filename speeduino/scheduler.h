...
/** @name KnockCallbacks
 * These are the (global) function pointers that get called to begin and end the knock measurements.
 * They are required for the various spark output modes.
 * @{
*/
extern void (*knk1StartFunction)(void);
extern void (*knk1EndFunction)(void);
extern void (*knk2StartFunction)(void);
extern void (*knk2EndFunction)(void);
extern void (*knk3StartFunction)(void);
extern void (*knk3EndFunction)(void);
extern void (*knk4StartFunction)(void);
extern void (*knk4EndFunction)(void);
/** @} */
...
inline void refreshKnockSchedule1(unsigned long timeToEnd) __attribute__((always_inline));
inline void refreshKnockSchedule2(unsigned long timeToEnd) __attribute__((always_inline));
inline void refreshKnockSchedule3(unsigned long timeToEnd) __attribute__((always_inline));
inline void refreshKnockSchedule4(unsigned long timeToEnd) __attribute__((always_inline));
