  ...
  table3d_dim_t lastBinMax)     // The last result from this call - used to speed up searches
{
  ...
  int16_t stride = maxElement>minElement ? 1 : -1;
...
static inline QU1X8_t compute_bin_position(table3d_axis_t value, const table3d_dim_t &bin, int16_t stride, const table3d_axis_t *pAxis)
{
