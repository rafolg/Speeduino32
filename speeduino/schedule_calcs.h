...
inline uint32_t __attribute__((always_inline)) calculateInjector1Timeout(const FuelSchedule &schedule, int injectorStartAngle, int crankAngle);
...
inline void __attribute__((always_inline)) calculateKnockAngle1(int knkStart, int knkWindow);
inline void __attribute__((always_inline)) calculateKnockAngle2(int knkStart, int knkWindow);
inline void __attribute__((always_inline)) calculateKnockAngle3(int knkStart, int knkWindow);
inline void __attribute__((always_inline)) calculateKnockAngle4(int knkStart, int knkWindow);
inline void __attribute__((always_inline)) calculateKnockAngles(int knkStart, int knkWindow);

inline uint32_t __attribute__((always_inline)) calculateKnockNTimeout(const KnockSchedule &schedule, int startAngle, int channelKnkDegrees, int crankAngle, int knkStart);
