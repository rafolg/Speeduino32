...
byte getTSLogEntry(uint16_t byteNum)
{
  ...
  switch(byteNum)
  {
    ...
    case 122: statusValue = currentStatus.knock1A; break;
    case 123: statusValue = currentStatus.knock2A; break;
    case 124: statusValue = currentStatus.knock3A; break;
    case 125: statusValue = currentStatus.knock4A; break;
    case 126: statusValue = currentStatus.knock1B; break;
    case 127: statusValue = currentStatus.knock2B; break;
    case 128: statusValue = currentStatus.knock3B; break;
    case 129: statusValue = currentStatus.knock4B; break;
    case 130: statusValue = currentStatus.knock1C; break;
    case 131: statusValue = currentStatus.knock2C; break;
    case 132: statusValue = currentStatus.knock3C; break;
    case 133: statusValue = currentStatus.knock4C; break;
    case 134: statusValue = currentStatus.knock1D; break;
    case 135: statusValue = currentStatus.knock2D; break;
    case 136: statusValue = currentStatus.knock3D; break;
    case 137: statusValue = currentStatus.knock4D; break;
    case 138: statusValue = currentStatus.airConStatus; break;
  }
...
int16_t getReadableLogEntry(uint16_t logIndex)
{
  ...
  switch(logIndex)
  {
    ...
    //case 59: It was unused; break;

    case 59: statusValue = currentStatus.fuelLoad; break;
    case 60: statusValue = currentStatus.ignLoad; break;
    case 61: statusValue = currentStatus.dwell; break;
    case 62: statusValue = currentStatus.CLIdleTarget; break;
    case 63: statusValue = currentStatus.mapDOT; break;
    case 64: statusValue = currentStatus.vvt1Angle; break;
    case 65: statusValue = currentStatus.vvt1TargetAngle; break;
    case 66: statusValue = currentStatus.vvt1Duty; break;
    case 67: statusValue = currentStatus.flexBoostCorrection; break;
    case 68: statusValue = currentStatus.baroCorrection; break;
    case 69: statusValue = currentStatus.VE; break; //Current VE (%). Can be equal to VE1 or VE2 or a calculated value from both of them
    case 70: statusValue = currentStatus.ASEValue; break; //Current ASE (%)
    case 71: statusValue = currentStatus.vss; break;
    case 72: statusValue = currentStatus.gear; break;
    case 73: statusValue = currentStatus.fuelPressure; break;
    case 74: statusValue = currentStatus.oilPressure; break;
    case 75: statusValue = currentStatus.wmiPW; break;
    ...
    case 88: statusValue = currentStatus.knock1A; break;
    case 89: statusValue = currentStatus.knock2A; break;
    case 90: statusValue = currentStatus.knock3A; break;
    case 91: statusValue = currentStatus.knock4A; break;
    case 92: statusValue = currentStatus.knock1B; break;
    case 93: statusValue = currentStatus.knock2B; break;
    case 94: statusValue = currentStatus.knock3B; break;
    case 95: statusValue = currentStatus.knock4B; break;
    case 96: statusValue = currentStatus.knock1C; break;
    case 97: statusValue = currentStatus.knock2C; break;
    case 98: statusValue = currentStatus.knock3C; break;
    case 99: statusValue = currentStatus.knock4C; break;
    case 100: statusValue = currentStatus.knock1D; break;
    case 101: statusValue = currentStatus.knock2D; break;
    case 102: statusValue = currentStatus.knock3D; break;
    case 103: statusValue = currentStatus.knock4D; break;
    case 104: statusValue = currentStatus.airConStatus; break;
  }
...
float getReadableFloatLogEntry(uint16_t logIndex)
{
  ...
  switch(logIndex)
  {
    ...
    case 88: statusValue = currentStatus.knock1A * 0.3922; break;
    case 89: statusValue = currentStatus.knock2A * 0.3922; break;
    case 90: statusValue = currentStatus.knock3A * 0.3922; break;
    case 91: statusValue = currentStatus.knock4A * 0.3922; break;
    case 92: statusValue = currentStatus.knock1B * 0.3922; break;
    case 93: statusValue = currentStatus.knock2B * 0.3922; break;
    case 94: statusValue = currentStatus.knock3B * 0.3922; break;
    case 95: statusValue = currentStatus.knock4B * 0.3922; break;
    case 96: statusValue = currentStatus.knock1C * 0.3922; break;
    case 97: statusValue = currentStatus.knock2C * 0.3922; break;
    case 98: statusValue = currentStatus.knock3C * 0.3922; break;
    case 99: statusValue = currentStatus.knock4C * 0.3922; break;
    case 100: statusValue = currentStatus.knock1D * 0.3922; break;
    case 101: statusValue = currentStatus.knock2D * 0.3922; break;
    case 102: statusValue = currentStatus.knock3D * 0.3922; break;
    case 103: statusValue = currentStatus.knock4D * 0.3922; break;
