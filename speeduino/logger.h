...
#include <assert.h>
  ...
  #define LOG_ENTRY_SIZE      139 /**< The size of the live data packet. This MUST match ochBlockSize setting in the ini file */
  #define SD_LOG_ENTRY_SIZE   139 /**< The size of the live data packet used by the SD card.*/
#else
...
#define SD_LOG_NUM_FIELDS   105 /**< The number of fields that are in the log. This is always smaller than the entry size due to some fields being 2 bytes */
...
const char header_75[] PROGMEM = "WMI PW";
...
const char header_88[] PROGMEM = "Knock 1A";
const char header_89[] PROGMEM = "Knock 2A";
const char header_90[] PROGMEM = "Knock 3A";
const char header_91[] PROGMEM = "Knock 4A";
const char header_92[] PROGMEM = "Knock 1B";
const char header_93[] PROGMEM = "Knock 2B";
const char header_94[] PROGMEM = "Knock 3B";
const char header_95[] PROGMEM = "Knock 4B";
const char header_96[] PROGMEM = "Knock 1C";
const char header_97[] PROGMEM = "Knock 2C";
const char header_98[] PROGMEM = "Knock 3C";
const char header_99[] PROGMEM = "Knock 4C";
const char header_100[] PROGMEM = "Knock 1D";
const char header_101[] PROGMEM = "Knock 2D";
const char header_102[] PROGMEM = "Knock 3D";
const char header_103[] PROGMEM = "Knock 4D";
const char header_104[] PROGMEM = "AirConStatus";
/*
