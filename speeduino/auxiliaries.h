...
#define BOOST_PIN_LOW()     (digitalWrite(pinBoost, HIGH))
#define BOOST_PIN_HIGH()    (digitalWrite(pinBoost, LOW))
#define VVT1_PIN_LOW()      (digitalWrite(pinVVT_1, HIGH))
#define VVT1_PIN_HIGH()     (digitalWrite(pinVVT_1, LOW))
#define VVT2_PIN_LOW()      (digitalWrite(pinVVT_2, LOW))
#define VVT2_PIN_HIGH()     (digitalWrite(pinVVT_2, HIGH))
#define FAN_PIN_LOW()       (digitalWrite(pinFan, HIGH))
#define FAN_PIN_HIGH()      (digitalWrite(pinFan, LOW))
...
#define WMI_PIN_LOW()       (digitalWrite(pinWMI, HIGH))
#define WMI_PIN_HIGH()      (digitalWrite(pinWMI, LOW))
#else
...
#define USB_IS_CONNECTED() (digitalRead(pinWserial) ? true : false)
...
#if(defined(CORE_TEENSY))
volatile PORT_TYPE *wmi_pin_port;
volatile PINMASK_TYPE wmi_pin_mask;
#endif
...
#if defined(CORE_TEENSY)
volatile bool wmi_pwm_state;
unsigned int wmi_pwm_max_count;
volatile unsigned int wmi_pwm_cur_value;
long wmi_pwm_target_value;
byte wmiCounter;
void wmiInterrupt(void);
#endif
