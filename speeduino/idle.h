...
#define IDLE_PIN_LOW()        (digitalWrite(pinIdle1, HIGH))
#define IDLE_PIN_HIGH()       (digitalWrite(pinIdle1, LOW))
#define IDLE2_PIN_LOW()       (digitalWrite(pinIdle2, HIGH))
#define IDLE2_PIN_HIGH()      (digitalWrite(pinIdle2, LOW))
#else
