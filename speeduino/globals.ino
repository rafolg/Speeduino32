...
int knock1EndAngle = 0;
int knock2EndAngle = 0;
int knock3EndAngle = 0;
int knock4EndAngle = 0;
...
volatile uint16_t knockCount; /**< The count of knock search events that have taken place since the engine started */
...
byte pinWMI;            // Water methanol output
byte pinWserial;
#endif
...
#if(defined(CORE_TEENSY))
  || ((pin == pinWMI)   && (configPage10.wmiEnabled > 0))
#else  
